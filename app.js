...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="task-item__field task";
    //button.edit
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.querySelector('.task-item__name').classList.add('task_done');
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.querySelector('.task-item__name').classList.remove('task_done');
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".task-item__toggle");
